  ...
  return (
    <main>
      <section className="px-5 pt-3 pb-5 flex flex-col gap-4 w-full">
        <h1 className="text-2xl">Политика обработки персональных данных</h1>
        <Divider />
        ...
        <p>
          ...
          данных&nbsp;Доктор Панг(далее – Оператор).
        </p>
        ...
        <ol className="list-decimal pl-8 flex flex-col gap-2">
          ...
          <li>
            ...
            сети интернет по сетевому адресу&nbsp;http://trepang.online/;
          </li>
          <li>
        ...
        <ol className="list-decimal pl-8 flex flex-col gap-2">
          ...
          <li>
            ...
            электронной почты&nbsp;info@trepang.online&nbsp;с пометкой «Отказ от
        ...
        <ol className="list-decimal pl-8 flex flex-col gap-2">
          <li>
            ...
            сайте&nbsp;http://trepang.online/. Заполняя соответствующие формы
        ...
        <ol className="list-decimal pl-8 flex flex-col gap-2">
          ...
          <li>
            ...
            Оператора&nbsp;info@trepang.online&nbsp;с пометкой «Актуализация
            персональных данных».
          </li>
          <li>
            ...
            Оператора&nbsp;info@trepang.online&nbsp;с пометкой «Отзыв согласия
        ...
        <h5 className="text-xl font-bold">8. Заключительные положения</h5>
        <ol className="list-decimal pl-8 flex flex-col gap-2">
          <li>
            ...
            к Оператору с помощью электронной почты&nbsp;info@trepang.online.
          </li>
          <li>
          ...
          <li>
            ...
            Интернет по адресу&nbsp;https://mysite.ru/policy/.
          </li>
        </ol>
      </section>
    </main>
