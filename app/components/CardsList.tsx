...
import { useGoodsData } from '../utils/placeholder-data';
            ...
            >
              <div className="card w-full bg-base-100 shadow-xl">
                ...
                <div className="flex gap-2 p-2 items-center">
                  <Button className="transition-all w-full bg-green-500 hover:bg-green-700 text-white rounded-md h-[36px] px-2">
                    Заказать на сайте
                  </Button>
                  <Button className="w-[36px] h-[36px] m-[6px] text-white rounded-md bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 transition-all hover:from-indigo-700 hover:via-purple-700 hover:to-pink-700">
                    WB
                  </Button>
                  <Button className="transition-all">
                    ...
                    >
                      <path
                        fill="#2962ff"
                        d="M13.5,6h21c4.142,0,7.5,3.358,7.5,7.5v21c0,4.142-3.358,7.5-7.5,7.5h-21C9.358,42,6,38.642,6,34.5	v-21C6,9.358,9.358,6,13.5,6z"
                      ></path>
                      <path
                        fill="#fff"
